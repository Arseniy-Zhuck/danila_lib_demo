...
for size_h in [32, 64, 96, 128, 160, 192, 224, 256, 288, 320, 352, 384]:
    for size_w in [32, 64, 96, 128, 160, 192, 224, 256, 288, 320, 352, 384]:
        test_results = 'vagon_autotest/tests_results/215_vagons_7000_im' + '_' +str(size_h) + '_' + str(size_w) + '.txt'
...
test_results = 'vagon_autotest/tests_results/215_vagons_7000_im_all_sizes.txt'
with open(test_results, "w") as new_f:
